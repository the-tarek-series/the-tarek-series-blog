            ...
            {cards.map((card) => (
              <button
                ...
                className={cn(
                  ...
                  card.matched ? 'bg-accent/10 border-accent text-accent cursor-default' : card.flipped ? 'bg-card border-accent text-foreground shadow-md' : 'bg-accent border-accent text-white hover:bg-accent/90 cursor-pointer'
                )}
              >
