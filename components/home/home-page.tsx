      ...
      <section className="relative min-h-[92vh] flex items-center pt-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-[1.08] mb-8" style={{ fontFamily: 'var(--font-playfair)' }}>
        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            <div className="p-12 lg:p-16 flex flex-col justify-center">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-5 leading-tight" style={{ fontFamily: 'var(--font-playfair)' }}>Train Your Memory with Psychology Games</h2>
              <p className="text-white/60 text-lg mb-8 leading-relaxed">Sharpen your cognitive abilities through science-backed memory exercises.</p>
              <Link href="/games">
            ...
            <div className="relative min-h-[320px] lg:min-h-0" style={{ backgroundImage: `url('https://images.pexels.com/photos/5428832/pexels-photo-5428832.jpeg?auto=compress&cs=tinysrgb&w=800')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
              <div className="absolute inset-0 bg-gradient-to-r from-slate-900/60 to-transparent lg:bg-gradient-to-l" />
            </div>
          </div>
        </div>
      </section>
