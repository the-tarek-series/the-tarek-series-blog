...
import { FileText, BookOpen, Mail, Users, Plus, ShoppingBag, ChartBar as BarChart3 } from 'lucide-react';
    ...
    <div className="pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {[
            { label: 'Analytics', desc: 'Traffic & insights', href: '/admin/analytics', icon: BarChart3 },
